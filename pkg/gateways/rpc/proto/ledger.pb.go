...
type GetAccountBalanceRequest struct {
	...
	AccountName string `protobuf:"bytes,1,opt,name=account_name,json=accountName,proto3" json:"account_name,omitempty"` // Represents an account.
}
...
func (x *GetAccountBalanceRequest) GetAccountName() string {
	if x != nil {
...
func (x *GetAccountBalanceResponse) GetAccountName() string {
	if x != nil {
		return x.AccountName
	}
	return ""
...
var file_pkg_gateways_rpc_proto_ledger_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xc5, 0x01, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x75, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x63, 0x75, 0x72, 0x72, 0x65,
