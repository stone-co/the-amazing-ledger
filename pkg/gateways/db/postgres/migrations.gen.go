...
func _000001_initialize_schemaDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_initialize_schema.down.sql", size: 243, mode: os.FileMode(0664), modTime: time.Unix(1606496577, 0)}
...
func _000001_initialize_schemaUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_initialize_schema.up.sql", size: 852, mode: os.FileMode(0664), modTime: time.Unix(1606496577, 0)}
