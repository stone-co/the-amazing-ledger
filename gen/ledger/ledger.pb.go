...
type CreateTransactionRequest struct {
	...
	CompetenceDate *timestamp.Timestamp `protobuf:"bytes,3,opt,name=competence_date,json=competenceDate,proto3" json:"competence_date,omitempty"`
...
func (x *CreateTransactionRequest) GetCompetenceDate() *timestamp.Timestamp {
	if x != nil {
...
func (x *GetAccountHistoryResponse) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
