...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_ledger_ledger_proto_rawDescGZIP(), []int{6, 0}
}
...
var file_ledger_ledger_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xf2, 0x01, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c, 0x74,
	...
	0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x43, 0x52, 0x45, 0x44, 0x49, 0x54, 0x10, 0x02, 0x32, 0x98,
	...
	0x74, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x7d, 0x30, 0x01, 0x32, 0x57, 0x0a, 0x06, 0x48, 0x65, 0x61,
...
var file_ledger_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_ledger_ledger_proto_goTypes = []interface{}{
	...
	(*HealthCheckResponse)(nil),            // 8: ledger.HealthCheckResponse
...
var file_ledger_ledger_proto_depIdxs = []int32{
	...
	1, // 3: ledger.HealthCheckResponse.status:type_name -> ledger.HealthCheckResponse.ServingStatus
	2, // 4: ledger.LedgerService.CreateTransaction:input_type -> ledger.CreateTransactionRequest
	4, // 5: ledger.LedgerService.GetAccountBalance:input_type -> ledger.GetAccountBalanceRequest
	6, // 6: ledger.LedgerService.GetAnalyticalData:input_type -> ledger.GetAnalyticalDataRequest
	9, // 7: ledger.Health.Check:input_type -> google.protobuf.Empty
	9, // 8: ledger.LedgerService.CreateTransaction:output_type -> google.protobuf.Empty
	5, // 9: ledger.LedgerService.GetAccountBalance:output_type -> ledger.GetAccountBalanceResponse
	7, // 10: ledger.LedgerService.GetAnalyticalData:output_type -> ledger.GetAnalyticalDataResponse
	8, // 11: ledger.Health.Check:output_type -> ledger.HealthCheckResponse
