...
// sources:
// migrations/000001_initialize_schema.down.sql
// migrations/000001_initialize_schema.up.sql
// DO NOT EDIT!
...
func _000001_initialize_schemaDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_initialize_schema.down.sql", size: 243, mode: os.FileMode(436), modTime: time.Unix(1611026141, 0)}
...
func _000001_initialize_schemaUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_initialize_schema.up.sql", size: 852, mode: os.FileMode(436), modTime: time.Unix(1611026141, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
