...
func (t *Transaction) AddEntry(id uuid.UUID, accountId string, expectedVersion vo.Version, operation vo.OperationType, amount int) {
	var pbOperation proto.Operation

	if operation == vo.DebitOperation {
